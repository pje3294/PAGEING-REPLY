...
<script type="text/javascript">
	...
	function redel(rid, mid){
		...
		check = confirm("해당 글을 영구적으로 삭제하시겠습니까?");
		if (check == true) {
			document.location.href = "control.jsp?action=redelete&rid="+rid+"&mcnt="+${mcnt}+"&mid="+mid;
...
<body>
	<div class="content">
		<ol>
			<li><a href="control.jsp?action=main">LOGO</a></li>
		...
		<c:forEach var="v" items="${datas}">
			...
			<h3>
				...
				${m.replycount} | ${m.day}] <a href="control.jsp?action=updatelike&mid=${m.mid}&mcnt=${mcnt}">👍</a>
	...
	<ol>
		...
		<li><a href="control.jsp?action=main&mcnt=${mcnt}&selUser=${n.memid}">${n.name}</a>님, 신규가입</li>
		</c:forEach>
	</ol>
	...
	<div class="adver">
		<ul>
			<li><a href="https://www.apple.com/"><img alt="애플" src="img/iphone.jpg" style="width: 200px; height: 200px;"></a></li>
			<li><a href="https://www.oliveyoung.co.kr/store/main/main.do?oy=0&chlNo=6&chlDtlNo=40&_CAD=nbsa03&utm_source=naver&utm_medium=brand_search&utm_campaign=onpro_emnet_main_0101_1231&utm_content=pc_main_text"><img alt="올리브영" src="img/olive.jpg" style="width: 200px; height: 200px;">
			</a></li>
